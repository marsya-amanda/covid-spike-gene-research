...
plot_events <- function(file_path, events) {
  ...
  # Build event window indicator: event day + 10 days after
...
plotted[[1]]$base_plot / plotted[[2]]$base_plot / plotted[[3]]$base_plot

plotted[[1]]$zoomed_plot / plotted[[2]]$zoomed_plot / plotted[[3]]$zoomed_plot
```
